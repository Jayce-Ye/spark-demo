...
object ParquetMergeSchema {
  ...
  def main(args: Array[String]): Unit = {
    ...
    studentsWithNameAgeDF.write.mode(SaveMode.Append).parquet("hdfs://spark1:9000/spark-study/students");
    ...
    studentsWithNameGradeDF.write.mode(SaveMode.Append).parquet("hdfs://spark1:9000/spark-study/students")
