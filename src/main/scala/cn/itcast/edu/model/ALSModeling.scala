...
object ALSModeling {
  def main(args: Array[String]): Unit = {
    ...
    val evaluator: RegressionEvaluator = new RegressionEvaluator()
      .setMetricName("rmse")//求误差:均方根误差 = (sum((rating-prediction)^2)/n)^(1/2)
      .setLabelCol("rating")
  ...
  def parseAnswerInfo(json: String): Rating = {
    ...
    val studentID: Long = answer.student_id.split("_")(1).toLong//学生id/用户id
    val questionID: Long = answer.question_id.split("_")(1).toLong//题目id/商品id
    val rating: Int = answer.score//题目得分/评分
